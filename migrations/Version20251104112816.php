 ...
 */
final class Version20251104112816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE objectifs (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, projet_id INT NOT NULL, sppa_id INT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, domaine_vie VARCHAR(255) NOT NULL, horizon VARCHAR(255) NOT NULL, priorite VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE DEFAULT NULL, progression DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, doc VARCHAR(255) DEFAULT NULL, INDEX IDX_7805601A76ED395 (user_id), INDEX IDX_7805601C18272 (projet_id), INDEX IDX_7805601A8867482 (sppa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE projets (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, sppa_id INT NOT NULL, nom VARCHAR(255) NOT NULL, type_projet VARCHAR(255) NOT NULL, categorie VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_debut DATE NOT NULL, date_fin DATE DEFAULT NULL, budget DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, piece_jointes VARCHAR(255) DEFAULT NULL, INDEX IDX_B454C1DBA76ED395 (user_id), INDEX IDX_B454C1DBA8867482 (sppa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE objectifs ADD CONSTRAINT FK_7805601C18272 FOREIGN KEY (projet_id) REFERENCES projets (id)');
